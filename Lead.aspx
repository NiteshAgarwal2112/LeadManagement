        ...
        <div class="modal-body">
          <table border="0" cellpadding="5" cellspacing="5" class="table table-responsive table-striped">
              ...
              <tr>
                 ...
                 <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Enter Correct email format" ControlToValidate="Email" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                   </td>
                   <td>
                      <asp:TextBox runat="server" ID="Phone"  placeholder="Phone" required=""  CssClass="form-control"/>
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"  
                                ControlToValidate="Phone" ErrorMessage="Enter 10 digit number only"  
